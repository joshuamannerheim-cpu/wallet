...
def _dex_url(chain,address):
    chain_map={'robinhood':'robinhood','base':'base','bsc':'bsc','ethereum':'ethereum','solana':'solana'}
    dex_chain=chain_map.get(str(chain or '').lower(),str(chain or '').lower())
    return f'https://dexscreener.com/{dex_chain}/{address}' if dex_chain and address else None
